        ...
        {navItems.map((item, index) => {
          ...
          return (
            <motion.button
              ...
              className={cn(
                "group relative flex items-center gap-3 overflow-hidden rounded-2xl border px-3 py-2.5 text-left transition-[border-color,background-color,color,transform]",
                active
